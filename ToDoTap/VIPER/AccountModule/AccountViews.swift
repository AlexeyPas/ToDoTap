...
class EmailView : BaseAccountView, ViewExtractable{
    ...
    func extractData() -> AccountData {
        return AccountAndPasswordData(Account: getEmail(), password: getPassword())
    }
...
//class PhoneView : BaseAccountView, ViewExtractable{
//    
//    weak var parentView: ViewToController?
//    
//    func checkValidation() -> Bool {
...
class SegmentView: UIView{
    ...
    private var AccountDict: [String:BaseAccountView] = [
        AuthType.AccountAndPassword.rawValue:EmailView(),
//        AuthType.phoneNumberAndSMS.rawValue:PhoneView()
    ]
    
    private var viewToExtract: ViewExtractable
    
    private let items = [AuthType.AccountAndPassword.rawValue]
...
//    }()
    private var customSegment :UISegmentedControl = {
        let control = UISegmentedControl(items: [AuthType.AccountAndPassword.rawValue])
    ...
    private func setupView(){
        //blockView = AccountDict[AuthType.AccountAndPassword.rawValue]!
